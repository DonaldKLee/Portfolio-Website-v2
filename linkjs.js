var remove1 = document.getElementById("removeaniafter1");
var remove2 = document.getElementById("removeaniafter2");
...
window.onload = setTimeout(function(){
	remove2.classList.remove("ani2");
}, 600);

window.onload = setTimeout(function(){
	remove3.classList.remove("ani3");
}, 900);

window.onload = setTimeout(function(){
	remove4.classList.remove("ani4");
}, 1200);
